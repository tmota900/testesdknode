...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApIv3Beta.FormsApi();
  });
  ...
  describe('FormsApi', function() {
    describe('getAllForms', function() {
      it('should call getAllForms successfully', function(done) {
        //uncomment below and update the code to test getAllForms
        //instance.getAllForms(function(error) {
