...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApIv3Beta.ComplexContactAllOfSmsStats();
  });
  ...
  describe('ComplexContactAllOfSmsStats', function() {
    it('should create an instance of ComplexContactAllOfSmsStats', function() {
      ...
      //var instane = new ApIv3Beta.ComplexContactAllOfSmsStats();
      //expect(instance).to.be.a(ApIv3Beta.ComplexContactAllOfSmsStats);
    });
