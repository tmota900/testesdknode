...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApIv3Beta.EmailEventsListStatsFields();
  });
  ...
  describe('EmailEventsListStatsFields', function() {
    it('should create an instance of EmailEventsListStatsFields', function() {
      ...
      //var instane = new ApIv3Beta.EmailEventsListStatsFields();
      //expect(instance).to.be.a(ApIv3Beta.EmailEventsListStatsFields);
    });
