...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApIv3Beta.ComplexContactAllOfVoiceStats();
  });
  ...
  describe('ComplexContactAllOfVoiceStats', function() {
    it('should create an instance of ComplexContactAllOfVoiceStats', function() {
      ...
      //var instane = new ApIv3Beta.ComplexContactAllOfVoiceStats();
      //expect(instance).to.be.a(ApIv3Beta.ComplexContactAllOfVoiceStats);
    });
