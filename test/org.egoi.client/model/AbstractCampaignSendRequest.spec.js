...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApIv3Beta.AbstractCampaignSendRequest();
  });
  ...
  describe('AbstractCampaignSendRequest', function() {
    it('should create an instance of AbstractCampaignSendRequest', function() {
      ...
      //var instane = new ApIv3Beta.AbstractCampaignSendRequest();
      //expect(instance).to.be.a(ApIv3Beta.AbstractCampaignSendRequest);
    });
