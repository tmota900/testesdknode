...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApIv3Beta.SendSmsAllOf2();
  });
  ...
  describe('SendSmsAllOf2', function() {
    it('should create an instance of SendSmsAllOf2', function() {
      // uncomment below and update the code to test SendSmsAllOf2
      //var instane = new ApIv3Beta.SendSmsAllOf2();
      //expect(instance).to.be.a(ApIv3Beta.SendSmsAllOf2);
    });
