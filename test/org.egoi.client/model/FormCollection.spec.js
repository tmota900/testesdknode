...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApIv3Beta.FormCollection();
  });
  ...
  describe('FormCollection', function() {
    it('should create an instance of FormCollection', function() {
      // uncomment below and update the code to test FormCollection
      //var instane = new ApIv3Beta.FormCollection();
      //expect(instance).to.be.a(ApIv3Beta.FormCollection);
    });
