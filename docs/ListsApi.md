...
let apiInstance = new ApIv3Beta.ListsApi();
let postRequestList = new ApIv3Beta.PostRequestList(); // PostRequestList | Parameters for the List
...
let apiInstance = new ApIv3Beta.ListsApi();
let listId = 56; // Number | ID of the List
let patchRequestList = new ApIv3Beta.PatchRequestList(); // PatchRequestList | Parameters for the List
