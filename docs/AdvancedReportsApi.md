...
let apiInstance = new ApIv3Beta.AdvancedReportsApi();
let generateEmailBouncesReport = new ApIv3Beta.GenerateEmailBouncesReport(); // GenerateEmailBouncesReport | Parameters for the email bounces report
...
let apiInstance = new ApIv3Beta.AdvancedReportsApi();
let generateEmailClicksByContactReport = new ApIv3Beta.GenerateEmailClicksByContactReport(); // GenerateEmailClicksByContactReport | Parameters for the email clicks by contact report
...
let apiInstance = new ApIv3Beta.AdvancedReportsApi();
let generateEmailClicksByUrlReport = new ApIv3Beta.GenerateEmailClicksByUrlReport(); // GenerateEmailClicksByUrlReport | Parameters for the email clicks by URL report
...
let apiInstance = new ApIv3Beta.AdvancedReportsApi();
let generateEmailEventsReport = new ApIv3Beta.GenerateEmailEventsReport(); // GenerateEmailEventsReport | Parameters for the email events report
...
let apiInstance = new ApIv3Beta.AdvancedReportsApi();
let generateSmsBouncesReport = new ApIv3Beta.GenerateSmsBouncesReport(); // GenerateSmsBouncesReport | Parameters for the SMS bounces report
...
let apiInstance = new ApIv3Beta.AdvancedReportsApi();
let generateEmailUnsubscriptionsReport = new ApIv3Beta.GenerateEmailUnsubscriptionsReport(); // GenerateEmailUnsubscriptionsReport | Parameters for the email unsubscriptions report
...
let apiInstance = new ApIv3Beta.AdvancedReportsApi();
let generateFormAnswersReport = new ApIv3Beta.GenerateFormAnswersReport(); // GenerateFormAnswersReport | Parameters for the form answers report
...
let apiInstance = new ApIv3Beta.AdvancedReportsApi();
let generateSendsReport = new ApIv3Beta.GenerateSendsReport(); // GenerateSendsReport | Parameters for the sends report
...
let apiInstance = new ApIv3Beta.AdvancedReportsApi();
let generateSmsEventsReport = new ApIv3Beta.GenerateSmsEventsReport(); // GenerateSmsEventsReport | Parameters for the SMS events report
...
let apiInstance = new ApIv3Beta.AdvancedReportsApi();
let generateSubscriptionsReport = new ApIv3Beta.GenerateSubscriptionsReport(); // GenerateSubscriptionsReport | Parameters for the subscriptions report
...
let apiInstance = new ApIv3Beta.AdvancedReportsApi();
let generateUnsubscriptionsReport = new ApIv3Beta.GenerateUnsubscriptionsReport(); // GenerateUnsubscriptionsReport | Parameters for the unsubscriptions report
