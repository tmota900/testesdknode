...
/**
* Campaigns service.
* @module org.egoi.client/org.egoi.client.api/CampaignsApi
* @version 3.0.0-beta
*/
export default class CampaignsApi {
    ...
    * @alias module:org.egoi.client/org.egoi.client.api/CampaignsApi
    * @class
    ...
    */
     ...
     * @callback module:org.egoi.client/org.egoi.client.api/CampaignsApi~deleteCampaignsCallback
     ...
     * @param {module:org.egoi.client/org.egoi.client.api/CampaignsApi~deleteCampaignsCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:org.egoi.client/org.egoi.client.api/CampaignsApi~getAllCampaignsCallback
     * @param {String} error Error message, if any.
     * @param {module:org.egoi.client/org.egoi.client.model/CampaignsCollection} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:org.egoi.client/org.egoi.client.model/String} opts.channel Channel of the campaign
     * @param {String} opts.campaignHash Hash of the campaign
     * @param {Number} opts.listId ID of the list where the campaign belongs
     * @param {module:org.egoi.client/org.egoi.client.model/String} opts.status Status of the campaign
     ...
     * @param {module:org.egoi.client/org.egoi.client.model/String} opts.orderBy Reference attribute to order campaigns (default to 'created')
     * @param {module:org.egoi.client/org.egoi.client.api/CampaignsApi~getAllCampaignsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:org.egoi.client/org.egoi.client.model/CampaignsCollection}
     */
