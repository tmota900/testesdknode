 ...
 * @module org.egoi.client/org.egoi.client.model/ComplexList
 * @version 3.0.0-beta
 */
class ComplexList {
    /**
     ...
     * Complex list schema
     * @alias module:org.egoi.client/org.egoi.client.model/ComplexList
     * @implements module:org.egoi.client/org.egoi.client.model/List
     * @implements module:org.egoi.client/org.egoi.client.model/ComplexListAllOf
     * @param publicName {String} Public name of the list
     * @param language {module:org.egoi.client/org.egoi.client.model/Language} 
     */
    constructor(publicName, language) { 
        List.initialize(this, publicName);ComplexListAllOf.initialize(this);
        ComplexList.initialize(this, publicName, language);
    }
     ...
     */
    static initialize(obj, publicName, language) { 
     ...
     * @param {module:org.egoi.client/org.egoi.client.model/ComplexList} obj Optional instance to populate.
     * @return {module:org.egoi.client/org.egoi.client.model/ComplexList} The populated <code>ComplexList</code> instance.
     */
...
/**
 * Status of the list
 * @member {module:org.egoi.client/org.egoi.client.model/ComplexList.StatusEnum} status
 */
...
/**
 * @member {module:org.egoi.client/org.egoi.client.model/ComplexListAllOfStats} stats
 */
